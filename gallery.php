    ...
    <div class="container-fluid py-5 px-0">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <h1 class="section-title position-relative text-center mb-5">Our products made from organic Material
                    </h1>
                </div>
            </div>
            <div class="row">
                <div class="col-12 text-center">
                    <ul class="list-inline mb-4 pb-2" id="portfolio-flters">
                        ...
                        <li class="btn btn-sm btn-outline-primary m-1" data-filter=".first">Portrait</li>
                        <li class="btn btn-sm btn-outline-primary m-1" data-filter=".second">Rectos</li>
                        <li class="btn btn-sm btn-outline-primary m-1" data-filter=".third">Versos</li>
                    </ul>
                </div>
            </div>
